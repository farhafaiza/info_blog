            ...
            <div class="py-2 shadow card border-left-primary h-100">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="mr-2 col">
                            <div class="mb-1 text-xs font-weight-bold text-primary">
                                Monthly Earning</div>
                            <div class="mb-0 text-gray-800 h5 font-weight-bold">$50,000</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="mb-4 col-xl-3 col-md-6">
            <div class="py-2 shadow card border-left-success h-100">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="mr-2 col">
                            <div class="mb-1 text-xs font-weight-bold text-success">
                                Yearly Earnings</div>
                            <div class="mb-0 text-gray-800 h5 font-weight-bold">$300,000</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="mr-2 col">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="mb-0 mr-3 text-gray-800 h5 font-weight-bold">60%</div>
                                </div>
                                <div class="col">
        ...
        <div class="mb-4 col-xl-3 col-md-6">
            <div class="py-2 shadow card border-left-warning h-100">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="mr-2 col">
                            <div class="mb-1 text-xs font-weight-bold text-warning">
                                Pending Requests</div>
                            <div class="mb-0 text-gray-800 h5 font-weight-bold">15</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="mb-4 col-lg-6">
            ...
            <div class="mb-4 shadow card">
                ...
                <div class="card-body">
                    <p>infoBlog has been created following youtube videos</p>
                    <p class="mb-0">GoD bless Youtube :|</p>
                </div>
            </div>
